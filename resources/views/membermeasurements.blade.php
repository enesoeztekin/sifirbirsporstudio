...
@section('content')
    ...
    <p class="text-white text-2xl">{{$member->fullname}} | Ölçümler
        <a href="/measurement/add/{{$member->id}}">
    ...
    <div class="flex flex-col mt-10">
        ...
        @else
            <p class="py-3 text-white font-normal"> Bu üyeye ait ölçüm bulunamadı. </p>
        @endif
    </div>
