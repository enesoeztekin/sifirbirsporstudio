...
@section('content')
    ...
    <div>
            ...
            <input type="text" id="package_name" name="package_name" class="block mt-3 py-2 px-4 w-full rounded-lg text-sm h-12 placeholder:text-gray-800" placeholder="Örneğin; 3 Aylık | Öğrenci (VIP)...">
    </div>
    <div>
        <label for="package_period" class="text-white text-sm">Paket Süresi (Ay):</label>
        <input type="text" id="package_period" name="package_period" class="block mt-3 py-2 px-4 w-full rounded-lg text-sm h-12 placeholder:text-gray-800" placeholder="Sayı olarak giriniz. Örn; 1, 3, 6, 12...">
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" id="package_cost" name="package_cost" class="block mt-3 py-2 px-4 w-full rounded-lg text-sm h-12 placeholder:text-gray-800" placeholder="Sayı olarak giriniz. Örneğin: 750, 1500, 2000... ">
    </div>
    <div>
